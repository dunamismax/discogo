...
// Package main provides Mage build targets for the Discord bot project.
package main
...
const (
	packageName = "github.com/dunamismax/discogo"
	botName     = "discord-bot"
	buildDir    = "bin"
	tmpDir      = "tmp"
)
...
func Build() error {
	...
	fmt.Println("Successfully built Discord bot!")
...
// Dev runs the Discord bot in development mode with auto-restart.
func Dev() error {
...
// Info shows information about the Discord Bot.
func Info() {
	fmt.Println("Discord Bot Template")
	fmt.Println("===================")
...
Examples:
  mage dev              # Run Discord bot in dev mode
  mage run              # Run Discord bot once  
